...
router.post('/', limits(8000, 15), authUser, validatorProductsCategory, productsCategoryCtrl.addOneCategory); // Ajoute un nouveau produit, uniquement par l'administrateur

router.put('/:idProductsCategory', limits(8000, 15), existProductsCategory, authUser, validatorProductsCategory, productsCategoryCtrl.updateOneCategory); // Modifie un produit, uniquement par l'administrateur
...
router.delete('/:idProductsCategory', limits(8000, 15), existProductsCategory, authUser, productsCategoryCtrl.deleteOneCategory); // Supprime un produit, uniquement par l'administrateur
